...
void main()
{
	...
	vec4 AlbedoMap = texture(Albedo, ps_in.TexCoords);
	vec3 AlbedoValue = AlbedoMap.rgb;
	// Linearize
	//vec3 AlbedoValue = pow(AlbedoValue.rgb, vec3(2.2));
	gAlbedo = vec4(AlbedoValue, AlbedoMap.a);
